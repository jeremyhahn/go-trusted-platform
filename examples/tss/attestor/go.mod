module github.com/jeremyhahn/go-trusted-platform/examples/tss/attestor

go 1.23.1

replace github.com/jeremyhahn/go-trusted-platform => ../../../

require (
	github.com/jeremyhahn/go-trusted-platform v0.0.0-00010101000000-000000000000
