...
// Account statuses (for /new-account)
// const (
// 	AccountStatusValid       = "valid"       // Account is active and valid
// 	AccountStatusDeactivated = "deactivated" // Account has been deactivated
// 	AccountStatusRevoked     = "revoked"     // Account has been revoked
// )
