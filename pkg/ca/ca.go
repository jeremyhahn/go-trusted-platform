...
type CertificateAuthority interface {
	...
	ImportAttestationKeyCertificate(domain, service string, akDER, caPassword []byte) error
	ImportAttestationEventLog(cn string, data, caPassword []byte) error
	ImportAttestationPCRs(cn string, pcrs []byte, caPassword []byte) error
	...
	VerifyAttestationPCRs(cn string, pcrs []byte) error
